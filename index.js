      ...
      postCard.className = "post-card";
        postCard.innerHTML = `
          ...
          <div class="post-actions">
            ...
            <button class="action-btn save-btn" onclick="window.open('${post.socialLink || '#'}', '_blank')" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor"><path d="M665.08-450H180v-60h485.08L437.23-737.85 480-780l300 300-300 300-42.77-42.15L665.08-450Z"/></svg></span>
     </button>
          </div>
        `;
